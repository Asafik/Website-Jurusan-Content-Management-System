...
@section('content')
            ...
            <div class="row justify-content-center">
                <div class="col-md-7 col-lg-8">
                    <div class="hero-content-wrap text-white text-center position-relative">
                        ...
                        <p class="lead">Teknologi Rekayasa Perangkat Lunak Jurusan Bisnis Dan Informatika.</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col">
                            <div class="h-3 text-left">
                                <div class="post-content">
                                    <h4>Indikator Kinerja Utama Prodi Teknologi Rekayasa Perangkat Lunak</h4>
                                    ...
                                    <p><strong>Berikut adalah data Indikator Kinerja Utama (IKU) Prodi Teknologi Rekayasa Perangkat Lunak:</strong></p>
                                    <div class="card">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        @foreach ($trpls as $index => $trpl)
                                                            <a class="dropdown-item {{ $index === 0 ? 'active' : '' }}" href="#" data-id="{{ $trpl->id }}">{{ $trpl->title }}</a>
                                                        @endforeach
                                                    </div>
                                                </div>
                                                <div class="btn-group">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Function to load IKU Prodi TRPL content based on ID
            function loadIkuProdiTrpl(id, title) {
                // Update dropdown button text
                dropdownButton.textContent = title;

                fetch(`/load-iku-prodi-trpl/${id}`)  // Mengganti URL endpoint
                    ...
                    .catch(error => console.error('Error fetching IKU Prodi TRPL:', error));
            }
