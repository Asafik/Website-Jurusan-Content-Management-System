<div class="modal fade text-left" id="ikuJurusanModal" tabindex="-1" role="dialog" aria-labelledby="ikuJurusanModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="ikuJurusanModal">Tambah IKU Jurusan</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="ikuJurusanForm" action="{{ route('iku-jurusans.store') }}" method="POST" data-request="ajax" data-success-callback="{{ route('iku-jurusans') }}">
                <div class="modal-body" style="max-height: calc(100vh - 200px); overflow-y: auto;">
                    <div class="form-group">
                        <label for="name">Tahun Indikator Kinerja Utama<span class="text-danger">*</span></label>
...
<script>
    ...
    document.querySelector('#ikuJurusanForm').addEventListener('submit', function() {
