...
@section('content')
            ...
            <div class="row justify-content-center">
                <div class="col-md-7 col-lg-8">
                    <div class="hero-content-wrap text-white text-center position-relative">
                        ...
                        <p class="lead">Teknologi Rekayasa Komputer Jurusan Bisnis Dan Informatika.</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col">
                            <div class="h-3 text-left">
                                <div class="post-content">
                                    <h4>Indikator Kinerja Utama Prodi Teknologi Rekayasa Komputer</h4>
                                    ...
                                    <p><strong>Berikut adalah data Indikator Kinerja Utama (IKU) Prodi Teknologi Rekayasa Komputer:</strong></p>
                                    <div class="card">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        @foreach ($trks as $index => $trk)
                                                            <a class="dropdown-item {{ $index === 0 ? 'active' : '' }}" href="#" data-id="{{ $trk->id }}">{{ $trk->title }}</a>
                                                        @endforeach
                                                    </div>
                                                </div>
                                                <div class="btn-group">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Function to load IKU Prodi TRK content based on ID
            function loadIkuProdiTrk(id, title) {
                // Update dropdown button text
                dropdownButton.textContent = title;

                fetch(`/load-iku-prodi-trk/${id}`)  // Mengganti URL endpoint
                    ...
                    .catch(error => console.error('Error fetching IKU Prodi TRK:', error));
            }
